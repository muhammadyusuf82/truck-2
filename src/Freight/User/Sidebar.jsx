...
const Sidebar = ({ onAddCargoClick }) => {
    ...
    const pages = [
        ...
        { id: 7, icon: FaCog, title: "Sozlamlar" },
      ...
      `}>
                <div className="sticky flex flex-col h-full py-8 px-5 overflow-y-auto">
                    ...
                    <div className="flex flex-col items-center mb-6">
                        ...
                        <h3 className="text-xl font-bold mt-3 text-slate-800">Ali Shirinov</h3>
                        <span className="text-xs font-bold text-[#4361ee] bg-blue-50 px-3 py-1 rounded-full uppercase mt-2">Yuk beruvchi</span>
