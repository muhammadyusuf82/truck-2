            ...
            <div className="bg-white rounded-xl p-4 md:p-6 shadow-sm border border-gray-200">
              ...
              <form onSubmit={handleSaveSettings}>
                ...
                <div className="pt-6 border-t border-gray-200 flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3">
                  ...
                  <button type="submit" className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg hover:shadow-lg transition-shadow">
                    Saqlash
                  </button>
                </div>
              </form>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="fixed top-6 right-6 z-50 space-y-3">
        {toasts.map((toast) => (
          <div 
            key={toast.id}
            className={`bg-white rounded-lg shadow-lg p-4 min-w-[300px] max-w-[400px] border-l-4 ${
            ...
            <div className="p-6">
              <form onSubmit={handleAddUser}>
                ...
                <div className="mt-8 pt-6 border-t border-gray-200 flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3">
                  ...
                  <button 
                    type="submit"
                    className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg hover:shadow-lg transition-shadow"
                  >
                    Qo'shish
                  </button>
                </div>
          ...
          <div className="bg-white rounded-xl w-full max-w-md">
            ...
            <div className="p-6 border-t border-gray-200 flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3">
              ...
              <button 
                ...
                className="px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 text-white font-semibold rounded-lg hover:shadow-lg transition-shadow"
              >
                O'chirish
              </button>
            </div>
